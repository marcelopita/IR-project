...
bool CollectionReader::getNextDocument(Document & doc) {
	...
	ulong beginOffset = 0, endOffset = 0, uncompressedPageSize = 0;
	...
	ulong nchars = fread(compressedDoc, sizeof(char), compressedDocSize, inputContentFilePtr_);
